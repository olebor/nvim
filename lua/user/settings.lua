...
vim.o.splitkeep = "screen"              -- Keep text put when a split opens, instead of scrolling it
vim.o.confirm = true                    -- Prompt to save on :q with unsaved changes instead of failing
